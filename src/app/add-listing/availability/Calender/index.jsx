...
const Calender = ({ data, dispatch, reducerType, showCalender=true, calenderRef}) => {
// const date = new Date()
...
// }) 
  ...
  return (
    <div 
      // ref={calenderRef} 
      className={` position-absolute top-112px right-0 w-fit-content radius-8px no-txt-select p-16px box-shadow-0_2 z-index-13 bg-neutral-000 ${showCalender ? 'display-block' : 'display-none'}`}>
